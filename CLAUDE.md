...
- **Profile** — _(Top-4 favorites picker: **done** — `/profile/top-shows`, drag-to-reorder via ☰ grip (`react-native-draglist`, same pattern as the list editor; PIL-20). Diary: **done** — `/profile/diary`, event-level watched log.)_ Remaining: nothing major on Profile itself.
